    ...
    <ul class="navbar-nav ml-auto mr-3 mr-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                ...
                <li>
                    <a onclick="event.preventDefault(); document.getElementById('form-logout-dashboard').submit()" class="dropdown-item" href="{{route('logout')}}">Logout</a>
                </li>
            </ul>
...
{{--                <li class="nav-item">--}}
{{--                    <a--}}
{{--                        onclick="event.preventDefault(); document.getElementById('form-logout-dashboard').submit()"--}}
